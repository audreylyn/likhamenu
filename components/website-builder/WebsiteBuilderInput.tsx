...
export const WebsiteBuilderInput: React.FC<WebsiteBuilderInputProps> = ({
  ...
  return (
    <div>
      ...
      <input
        {...props}
        className="mt-1 block w-full px-4 py-2 border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-amber-400 focus:border-amber-400 sm:text-sm"
      />
    </div>
  );
};
